...
socket_handle SocketConnector::connect(const std::string &address, int port,
                                       bool noDelay, int sendBufSize,
                                       int rcvBufSize,
...
socket_handle SocketConnector::connect(const std::string &address, int port,
  ...
  socket_handle socket =
      connect(address, port, noDelay, sendBufSize, rcvBufSize, "", 0);
  return socket;
}
