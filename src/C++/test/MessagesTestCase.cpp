...
TEST_CASE("MessageTests")
{
  ...
  SECTION("testRequestGetString")
  {
    ...
    CHECK( "8=FIX.4.2\0019=12\00135=1\001112=23\00110=007\001"
           == object.toString() );
  }
  ...
  SECTION("resendRequestGetString")
  {
    ...
    CHECK( "8=FIX.4.2\0019=16\00135=2\0017=1\00116=233\00110=184\001"
           == object.toString() );
  }
  ...
  SECTION("sequenceResetGetString")
  {
    ...
    CHECK( "8=FIX.4.2\0019=17\00135=4\00136=88\001123=Y\00110=028\001"
           == object.toString() );
  }
  ...
  SECTION("logoutGetString")
  {
    ...
    CHECK( "8=FIX.4.2\0019=18\00135=5\00158=See Ya...\00110=006\001"
           == object.toString() );
  }
